  ...
  <div class="layout">
    ...
    <div class="main-column">
      <header class="hero">
        ...
        <h1>מ־0 למוצר מקצועי עם IBM Bob</h1>
        <p>פיתוח תוכנה מבוסס AI — מתודה, אחריות, ופרויקט Capstone מלא</p>
      </header>
      <main class="content">
        <section class="section">
          <div class="section-label label-goal"><span class="dot"></span>איך ללמוד</div>
          <div class="card card-goal">
            <p>קראו לפי הסדר. בצעו מעבדה בכל פרק. <strong>אל תאשרו פעולה שאינכם מסוגלים להסביר.</strong></p>
        ...
        <section class="section">
          ...
          <div class="prereq-grid">
            ...
            <div class="prereq-item"><strong>Python 3.11+</strong><span>pip, שרת מקומי</span></div>
            <div class="prereq-item"><strong>Git</strong><span>commits, diff, branches</span></div>
          </div>
        ...
        <section class="section">
          ...
          <div class="card card-capstone">
            ...
            <p style="margin-top:1rem;font-size:0.92rem">פרקים 11–28 מקשרים כל נושא ל-${esc(CAPSTONE.name)}. פרקים 29–30 מרחיבים ל-IBM i ו-IBM Z.</p>
          </div>
        </section>
